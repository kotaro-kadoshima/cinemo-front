  ...
  return (
    <main className="min-h-screen bg-black text-white px-6 py-12">
      ...
      <section className="text-center">
        <h1 className="text-3xl md:text-4xl font-extrabold">今日はどんな一日だった？</h1>
        <p className="mt-2 text-gray-400">日記みたいに気持ちを書いてください。映画でお返事します。</p>
      </section>
      ...
      >
        ...
        >
          ...
          <div className="mt-6">
            ...
            <div className="flex flex-wrap gap-2" role="group" aria-label="制作国フィルタ">
                ...
                return (
                  <button
                    ...
                    className={
                      ...
                      (active
                        ? 'bg-red-500/80 border-red-500 text-white shadow-[0_0_0_1px_rgba(255,255,255,0.06)]'
                        : 'bg-black/40 border-white/15 text-gray-300 hover:border-red-500 hover:text-white')
                    }
                  >
                    {c.label}
                  </button>
          ...
          <div className="flex flex-wrap gap-2" role="group" aria-label="ジャンルフィルタ">
            {/* すべて（選択解除） */}
            {(() => {
              const allActive = genres.length === 0;
              return (
                <button
                  key="all-genres"
                  type="button"
